...
namespace SaveScripts
{
    public static class SaveSystem
    {
        ...
        public static void SavePlayer(LevelSystem levelsystem, PlayerAttributes attributes, SkillTree skills, CombatSystem combatSystem, PlayerInventory playerInventory, SaveData player, PlayerQuests playerQuests)
        {
            BinaryFormatter formatter = new BinaryFormatter();
            string path = Application.persistentDataPath + "/player.save";
            FileStream stream = new FileStream(path, FileMode.Create);

            PlayerData data = new PlayerData(levelsystem, attributes, skills, combatSystem, playerInventory, player, playerQuests);
